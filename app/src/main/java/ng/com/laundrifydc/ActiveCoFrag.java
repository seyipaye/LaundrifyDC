...
public class ActiveCoFrag extends DialogFragment {
    Context context;
    RecyclerView.Adapter activeCoAdapter;
    static List<String> coKeys;
    static String coDataDay;
    List<Active_Model> active_models;
    private final int CALL_REQUEST = 100;
    private String callNumber;
    TextView descText;
    RecyclerView activeCoRV;
    ProgressBar pBar;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        activeCoRV = v.findViewById(R.id.activeRec);
        descText = v.findViewById(R.id.descText);
        descText.setText("This shows all collected orders for the selected day");
        activeCoRV.setLayoutManager(new LinearLayoutManager(this.getActivity()));
        activeCoAdapter = new ActiveCoFrag.ActiveCo_Adapter();
        active_models = new ArrayList<>();
        activeCoRV.setAdapter(activeCoAdapter);
    ...
    public class ActiveCo_Adapter extends RecyclerView.Adapter<ActiveCo_Adapter.MyViewHolder> {
        ...
        @NonNull
        @Override
        public ActiveCo_Adapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(context).inflate(R.layout.active_row, parent, false);
            ActiveCo_Adapter.MyViewHolder myViewHolder = new ActiveCo_Adapter.MyViewHolder(view);
            return myViewHolder;
        }

        @Override
        public void onBindViewHolder(@NonNull ActiveCo_Adapter.MyViewHolder holder, final int position) {
